...
//        }
    ...
    private boolean countDigit(long isbn) {
       ...
       int count = 0;
       long temp = isbn; // isbn нужно отложить в переменную, иначе мы ее изменим в цикле до значения 0
       while ((temp != 0)) {
           temp = temp/10;
           count++;
       }
    ...
    // TODO предусмотреть защиту по поводу 13 цифр и в этом случае тоже
