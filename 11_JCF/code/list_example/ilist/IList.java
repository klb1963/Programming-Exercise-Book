package list_example.ilist;

// зададим абстрактные методы для работы со структурой данных "лист/list" (список чего-то),
// для любых типов данных Integer, String, StringBuilder, Employee, CarNew, Pet, Photo, Book ...
...
public interface IList<E> extends Iterable<E> {
    ...
    int lastIndexOf(Object o);// ищем индекс элемента с правого конца списка
}
